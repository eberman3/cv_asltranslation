...
class Datasets():
    ...
    def get_data(self, path, shuffle, augment):
        ...
        train_data = data_gen.flow_from_directory(directory=path, target_size=(img_size, img_size),
                                                     class_mode="sparse", shuffle=shuffle, batch_size=hp.batch_size, classes=classes_for_flow, subset="training")
        test_data = data_gen.flow_from_directory(directory=path, target_size=(img_size, img_size),
                                                    class_mode="sparse", shuffle=shuffle, batch_size=hp.batch_size, classes=classes_for_flow, subset="validation")
